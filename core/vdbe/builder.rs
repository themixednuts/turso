...
pub struct ProgramBuilder {
    ...
    ctes_being_defined: Vec<crate::IdentKey>,
    ...
    pub id_register_overrides: HashMap<crate::IdentKey, usize>,
...
impl ProgramBuilder {
    ...
    pub fn push_cte_being_defined(&mut self, name: crate::IdentKey) {
    ...
    pub fn mask_shadowed_ctes_being_defined(
        &mut self,
        shadowing_names: &[crate::IdentKey],
    ) -> Vec<crate::IdentKey> {
    ...
    pub fn unmask_shadowed_ctes_being_defined(&mut self, masked: Vec<crate::IdentKey>) {
    ...
    pub fn take_ctes_being_defined(&mut self) -> Vec<crate::IdentKey> {
        std::mem::take(&mut self.ctes_being_defined)
    }

    /// Restore the CTE-being-defined stack after a context-isolated expansion.
    pub fn restore_ctes_being_defined(&mut self, saved: Vec<crate::IdentKey>) {
