    ...
    match insn {
            ...
            Insn::DropTable {
                ...
                *db as i64,
                0,
                0,
                Value::build_text(table_name.as_str().to_owned()),
                0,
            ...
            Insn::DropTrigger { db, trigger_name } => (
                ...
                *db as i64,
                0,
                0,
                Value::build_text(trigger_name.as_str().to_owned()),
                0,
            ...
            Insn::DropType { db, type_name } => (
                ...
                *db as i64,
                0,
                0,
                Value::build_text(type_name.as_str().to_owned()),
                0,
            ...
            Insn::DropSequence { db, seq_name } => (
                ...
                *db as i64,
                0,
                0,
                Value::build_text(seq_name.as_str().to_owned()),
                0,
            ...
            Insn::DropView { db, view_name } => (
                ...
                *db as i64,
                0,
                0,
                Value::build_text(view_name.as_str().to_owned()),
                0,
            ...
            Insn::Savepoint { op, name } => (
                ...
                0,
                0,
                Value::build_text(name.as_str().to_owned()),
                0,
            ...
            Insn::RenameTable { db: _, from, to } => (
                ...
                Value::build_text(""),
                0,
                format!("rename_table({from}, {})", to.as_str()),
            ),
