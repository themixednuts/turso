...
impl TableReferences {
    ...
    pub fn find_outer_query_ref_by_identifier(
        ...
        self.outer_query_refs
            .iter()
            .find(|t| crate::IdentKeyStr::new(&t.identifier) == identifier)
    }
        ...
        self.joined_tables
            ...
            .or_else(|| {
                self.outer_query_refs
                    .iter()
                    .find(|t| {
                        crate::IdentKeyStr::new(&t.identifier) == identifier
...
pub struct Window {
    ...
    pub name: Option<crate::IdentKey>,
...
impl Window {
    ...
    /// resolved frame.
    pub fn from_named_bound(name: crate::IdentKey, bound: NamedWindowBound, frame: Frame) -> Self {
        Window {
            name: Some(name),
