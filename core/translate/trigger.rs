...
pub fn translate_create_trigger(
    ...
    let normalized_trigger_name = trigger_name.name.to_key();
    let normalized_table_name = tbl_name.name.to_key();
    let database_id =
    ...
    let normalized_table_name = String::from(normalized_table_name);
